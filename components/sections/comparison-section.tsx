...
export default function ComparisonSection() {
  ...
  return (
    <section id="comparison" ref={ref} className="section-padding relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="section-subtitle max-w-3xl mx-auto">
            Compare the performance and capabilities of single-core and multi-core processors across different computing
            tasks.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h3 className="text-xl font-semibold mb-4">Interactive Comparison</h3>
            ...
            <div className="relative h-[400px] mb-6 overflow-hidden rounded-lg border border-border">
              ...
              >
                <div className="absolute inset-0 p-6">
                  <h4 className="text-lg font-medium mb-4 text-left text-primary">Single-Core Processor (2000s)</h4>
              ...
              <div className="absolute inset-0 p-6">
                <h4 className="text-lg font-medium mb-4 text-right text-accent">Multi-Core Processor (Modern)</h4>
                <div className="space-y-4">
                  <div>
                    <p className="font-medium">Web Browsing</p>
            ...
            <div className="bg-card border border-border rounded-xl p-6 card-hover">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Parallel Processing:</span> Multiple cores can handle different tasks
                    simultaneously
                  </p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Improved Multitasking:</span> Better performance when running multiple
                    applications
                  </p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Power Efficiency:</span> Better performance per watt compared to
                ...
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Specialized Workloads:</span> Cores can be optimized for specific
            ...
            <div className="bg-card border border-border rounded-xl p-6 card-hover">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Thread Synchronization:</span> Coordinating tasks across multiple
                    cores
                  </p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Cache Coherence:</span> Maintaining consistent memory state across
                    core caches
                  </p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Software Optimization:</span> Not all applications are designed for
                    parallel execution
                  </p>
                </li>
                <li className="flex items-start">
                  ...
                  <p className="text-sm">
                    <span className="font-medium">Heat Dissipation:</span> Managing thermal output from multiple active
                    cores
                  </p>
                </li>
              </ul>
